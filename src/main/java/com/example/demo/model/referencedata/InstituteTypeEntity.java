...
@Entity
@Table(name = "institute_type", uniqueConstraints = {@UniqueConstraint(columnNames = {"code"})})
public class InstituteTypeEntity extends BaseEntity {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InstituteTypeEntity)) {
      return false;
    }

    InstituteTypeEntity that = (InstituteTypeEntity) o;
